                        ...
                        <tbody>
                            ...
                            foreach ($content as $row) : $no++; ?>
                                <tr>
                                    ...
                                    <td>
                                        <p>
                                            <img src="<?= $row->image ? base_url("images/product/$row->image") : base_url("images/product/default.jpg") ?>" width="50px" alt="">
                                            <?= $row->product_title; ?>
                                        </p>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?= base_url("/product/edit/$row->id") ?>"><button class="btn btn-sm" type="button">
