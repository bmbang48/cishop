        ...
        <div class="col-md-12">
            <div class="card mb-3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="<?= base_url("cart/delete/$row->id") ?>" method="POST">
                                            <input type="hidden" name="id" value="<?= $row->id ?>">
                                            <button class="btn btn-danger" type="submit" onclick="return confirm('Yakin ingin hapus ? ')"><i class="fas fa-trash-alt"></i></button>
                                        </form>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                ...
                <div class="card-footer">
                    ...
                    <a href="<?= base_url('/') ?>" class="btn btn-warning text-white"><i class="fas fa-angle-left"></i>Kembai Belanja</a>
                </div>
            </div>
        </div>
    </div>
